    ...
    $.fn.amsifySuggestags = function(options, method) {
        ...
        AmsifySuggestags.prototype = {
            ...
            createHTML : function() {
              ...
              var sTagsInput                = '<input type="text" id="tagInput" list="taglist" class="'+this.classes.sTagsInput.substring(1)+'" placeholder="'+this.defaultLabel+'">';
              ...
              var list = '<ul id="amsify-list" class="' + this.classes.list.substring(1) + '"></ul>';
